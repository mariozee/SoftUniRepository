namespace BuhtigIssueTracker.Models
{
    ...
    public class Issue
    {
        ...
        public Issue(string title, string description, IssuePrority priority, List<string> tags)
        {
            Title = title;
        ...
        public IssuePrority Priority { get; set; }
        ...
        private string GetPriorityAsString()
        {
            ...
            {
                case IssuePrority.Showstopper: return "****";
                case IssuePrority.High: return "***";
                case IssuePrority.Medium: return "**";
                case IssuePrority.Low: return "*";
                default:
